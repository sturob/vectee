(function() {
  ...
  */
  ...
  NearestInterpolator = (function() {
    __extends(NearestInterpolator, AbstractInterpolator);
  ...
  LinearInterpolator = (function() {
    __extends(LinearInterpolator, AbstractInterpolator);
  ...
  CubicInterpolator = (function() {
    __extends(CubicInterpolator, AbstractInterpolator);
    ...
    CubicInterpolator.prototype.getTangent = function(k) {
      return this.tangentFactor * (this.getClippedInput(k + 1) - this.getClippedInput(k - 1));
    };
  ...
  Smooth = function(arr, config) {
    var dataType, err, i, interpolator, interpolatorClass, interpolators, k, v, _ref;
    if (config == null) {
      config = {};
    }
    ...
    switch (dataType) {
      ...
      case '[object Array]':
        interpolators = (function() {
          var _ref2, _results;
          _results = [];
          for (i = 0, _ref2 = arr[0].length; 0 <= _ref2 ? i < _ref2 : i > _ref2; 0 <= _ref2 ? i++ : i--) {
