...
/*			if (!hasTouch) {
		...
		goToPage: function (p) { p = p - 0; // safety
			var i;
		...
		__pos: function (x) {
			this.x = x;
      this.options.__pos && this.options.__pos.call( this, x )
...
/*			var matrix = getComputedStyle(this.slider, null).webkitTransform.replace(/[^0-9-.,]/g, '').split(',');
			this.x = matrix[4] * 1;*/
      this.options.__start && this.options.__start.call(this);
...
/*			if (newX > 0 || newX < this.maxX) {
      ...
      if (dist < this.snapThreshold) {
        ...
        this.__pos(-this.page * this.pageWidth);
        this.options.__end && this.options.__end.call(this, 'nosnap')
        return; // revert to original page
      }
        ...
        this.options.__end && this.options.__end.call(this, 'backwards');
			} else {
				...
				pageFlipIndex = this.page + 1;
        this.options.__end && this.options.__end.call(this, 'forwards');
			}
